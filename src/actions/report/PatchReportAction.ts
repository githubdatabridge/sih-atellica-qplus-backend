...
@injectable()
@autoInjectable()
export class PatchReportAction extends BaseAction<Report> {
    constructor(
    ...
    async run(
        ...
        try {
            ...
            if (
                ...
                reportFromDb.datasetId !== dataForUpdate.datasetId
            ) {
            ...
            const visualizations = JSON.parse(dataset.visualizations) as {
                name: string;
            }[];

            const checkVisualizationType =
                dataForUpdate.visualizationType !== undefined ||
                dataForUpdate.datasetId !== undefined;

            if (
                checkVisualizationType &&
                !visualizations.some(
            ...
            delete reportToUpdate.dataset;
            delete reportToUpdate.qlikState;
            ...
            if (userData.user.appUserId === result.appUserId) {
